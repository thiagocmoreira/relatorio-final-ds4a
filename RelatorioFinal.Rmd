...
Com a primeira fase já previamente estabelecida, uma outra etapa tão importante quanto é a fase de inspecionar, organizar e descrever os dados disponíveis para a resolução do problema. É uma etapa importante também para a familiarização com os dados de insumo para a realização das análises, possibilitando também que alguns insights sejam previamente levados em consideração para etapas futuras. [6]
